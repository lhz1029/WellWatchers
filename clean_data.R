...
#
#
# EDIT: We kept the subvillages so that we could analyze it ourselves.
#############################################################################################

train <- read.csv("/Users/cindyzhao0521/Dropbox/Classes/CS109/Final Project/training_set_values.csv")
test <- read.csv("/Users/cindyzhao0521/Dropbox/Classes/CS109/Final Project/test_set_values.csv")
...
write.csv(train, "/Users/cindyzhao0521/Dropbox/Classes/CS109/Final Project/clean_training_set_values.csv", row.names=FALSE)
write.csv(test, "/Users/cindyzhao0521/Dropbox/Classes/CS109/Final Project/clean_test_set_values.csv", row.names=FALSE)
